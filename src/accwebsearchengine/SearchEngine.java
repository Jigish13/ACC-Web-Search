 ...
 * @version: 1.3
 * @purpose: This Class accepts the string and performs the search on stored URL's in text file.
 */
...
public class SearchEngine {
    ...
    public static String[] getKeywords(String inputStr) {
        int i = 0;
        In in = new In("E:\\MAC\\ACC\\Web-Search-Engine\\ACC-Web-Search-Engine\\src\\accwebsearchengine\\stop-words.txt");
...
//        }
    ...
    public static HashMap<Integer, Integer> getFreqList(String[] keyWords) {
        ...
        File folder = new File("E:\\MAC\\ACC\\Web-Search-Engine\\ACC-Web-Search-Engine\\src\\accwebsearchengine\\urls");
        ...
        for (int i = 0; i < textList.size(); i++) {
            ...
            String filePath = "E:\\MAC\\ACC\\Web-Search-Engine\\ACC-Web-Search-Engine\\src\\accwebsearchengine\\urls\\";
...
//	        }
    ...
    public static void storeHashMap(HashMap<Integer, Integer> freqList, String[] keyWords) {
        ...
        String filePath = "E:\\MAC\\ACC\\Web-Search-Engine\\ACC-Web-Search-Engine\\src\\accwebsearchengine\\hashmap_data/";
        String finalPath = filePath + fileName;
    ...
    public static void main(String[] args) {
        ...
        String mySearch = "Computing Concepts";
        ...
        File folder = new File("E:\\MAC\\ACC\\Web-Search-Engine\\ACC-Web-Search-Engine\\src\\accwebsearchengine\\hashmap_data");
        File[] files = folder.listFiles();
